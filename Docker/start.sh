...
gunicorn --bind 0.0.0.0:8080 --workers=1 -k special_uvicorn_worker.NoProxyHeadersUvicornWorker --disable-redirect-access-to-syslog --keep-alive 200 --access-logfile - main:app