...
- Support PASCAL probabilities NetCDF files with many dimensions
...
- **Breaking change: added script (Docker/start_autosync.sh) to autosync layermetadata store. Docker compose starts related container @maartenplieger in https://github.com/KNMI/adaguc-server/pull/476**
