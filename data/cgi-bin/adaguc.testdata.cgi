...
export ADAGUC_CONFIG="${ADAGUC_PATH}/data/config/adaguc.testdata.xml"
export ADAGUC_DATARESTRICTION="FALSE" 
export ADAGUC_LOGFILE="${ADAGUC_TMP}/adaguc.testdata.log"
export ADAGUC_ERRORFILE="${ADAGUC_TMP}/adaguc.testdata.errlog"
export ADAGUC_FONT="${ADAGUC_PATH}/data/fonts/FreeSans.ttf"
export ADAGUC_ONLINERESOURCE="http://${HTTP_HOST}/cgi-bin/adaguc.testdata.cgi?"
