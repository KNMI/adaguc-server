...
void CReporter::addMessage(const std::string &message, CReportMessage::Severities severity, CReportMessage::Categories category, const std::string &documentationLink, const char *file, int line,
