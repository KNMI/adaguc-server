...
void *CHTTPTools::myrealloc(void *ptr, size_t size) {
...
size_t CHTTPTools::WriteMemoryCallback(void *ptr, size_t size, size_t nmemb, void *data) {
...
int CHTTPTools::getBuffer(const char *url, char *&buffer, size_t &length, long maxFileSize) {
...
std::string CHTTPTools::getString(const char *url, float maxFileSize) {
  char *buffer = NULL;
  size_t length = 0;
