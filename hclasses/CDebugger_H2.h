...
template <class myFreeType> void _allocateArray(myFreeType *object[], size_t elements, const char *file, const int line) {
  if (*object != NULL) {
    delete[] * object;
    *object = NULL;
  }
...
template <class myFreeType> void deleteObject(myFreeType *object) {
  if (*object != NULL) {
    delete *object;
    *object = NULL;
  }
