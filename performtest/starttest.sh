...
../adagucserver/adagucserver --updatedb --config data/RADNL_OPER_R___25PCPRR_L3.xml  1>/dev/null 
...
../adagucserver/adagucserver >  testresults/test_wms-getmap.out
...
export QUERY_STRING="service=WMS&REQUEST=GetCapabilities"
 ../adagucserver/adagucserver > testresults/test_wms-getcapabilities.out
...
export QUERY_STRING="service=WMS&REQUEST=GetFeatureInfo&width=256&height=256&BBOX=0,48,10,58&SRS=EPSG:4326&LAYERS=RADNL_OPER_R___25PCPRR_L3_COLOR&info_format=text/plain&X=128&Y=128"
 ../adagucserver/adagucserver > testresults/test_wms-getfeaturinfo.txt
...
../adagucserver/adagucserver >  testresults/test_wms-getmap_animation.out
...
export QUERY_STRING="service=WMS&REQUEST=GetMetadata&format=text/plain&width=256&height=256&BBOX=0,48,10,58&SRS=EPSG:4326&LAYER=RADNL_OPER_R___25PCPRR_L3_COLOR"
  ../adagucserver/adagucserver > testresults/test_wms-getmetadata.txt