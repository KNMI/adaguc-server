...
void CCairoPlotter::writeToPng24Stream(FILE *fp, unsigned char) { writePng(width, height, ARGBByteBuffer, fp, 24, false); }

void CCairoPlotter::writeToPng8Stream(FILE *fp, unsigned char, bool use8bitpalAlpha) { writePng(width, height, ARGBByteBuffer, fp, 8, use8bitpalAlpha); }
