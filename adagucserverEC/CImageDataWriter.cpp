...
//       }
      ...
      for(size_t dataObjectNr=0;dataObjectNr<dataSources[d]->dataObjects.size();dataObjectNr++){
        CDataSource::DataObject *dataObject = dataSources[d]->getDataObject(dataObjectNr);
