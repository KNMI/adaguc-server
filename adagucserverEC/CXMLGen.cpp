...
int CXMLGen::getWMS_1_0_0_Capabilities(std::string *XMLDoc, std::vector<MetadataLayer *> *metadataLayerList) {
...
int CXMLGen::getWMS_1_1_1_Capabilities(std::string *XMLDoc, std::vector<MetadataLayer *> *metadataLayerList) {
  std::string onlineResource = srvParam->getOnlineResource();
  onlineResource += "SERVICE=WMS&amp;";
...
int CXMLGen::getWMS_1_3_0_Capabilities(std::string *XMLDoc, std::vector<MetadataLayer *> *metadataLayerList) {
  std::string onlineResource = srvParam->getOnlineResource();
  onlineResource += "SERVICE=WMS&amp;";
...
int CXMLGen::getWCS_1_0_0_Capabilities(std::string *XMLDoc, std::vector<MetadataLayer *> *metadataLayerList) {
  std::string onlineResource = srvParam->getOnlineResource();
...
int CXMLGen::getWCS_1_0_0_DescribeCoverage(std::string *XMLDoc, std::vector<MetadataLayer *> *metadataLayerList) {
