...
template <class T>
void CImgRenderStippling::_stippleMiddleOfPoints() {
...
void CImgRenderStippling::render(CImageWarper *warper,CDataSource *dataSource,CDrawImage *drawImage){
  ...
  if (yDistance == 0 || xDistance ==0 ){
    switch(dataType){
      case CDF_CHAR  : _stippleMiddleOfPoints <char>();break;
      case CDF_BYTE  : _stippleMiddleOfPoints <char>();break;
      case CDF_UBYTE : _stippleMiddleOfPoints <unsigned char>();break;
      case CDF_SHORT : _stippleMiddleOfPoints <short>();break;
      case CDF_USHORT: _stippleMiddleOfPoints <unsigned short>();break;
      case CDF_INT   : _stippleMiddleOfPoints <int>();break;
      case CDF_UINT  : _stippleMiddleOfPoints <unsigned int>();break;
      case CDF_FLOAT : _stippleMiddleOfPoints <float>();break;
      case CDF_DOUBLE: _stippleMiddleOfPoints <double>();break;
    }
    return;
  }
