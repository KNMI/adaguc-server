...
#define ADAGUCSERVER_VERSION "2.31.3" // Please also update in the Dockerfile to the same version
...
#define RENDERSETTINGS_RENDER_NEAREST "nearest"
#define RENDERSETTINGS_RENDER_BILINEAR "bilinear"
#define RENDERSETTINGS_RENDER_SHADED "shaded"
#define RENDERSETTINGS_RENDER_CONTOUR "contour"
