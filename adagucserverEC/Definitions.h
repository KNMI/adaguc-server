...
<<<<<<< HEAD
#define ADAGUCSERVER_VERSION "2.8.0" // Please also update in the Dockerfile to the same version
=======
#define ADAGUCSERVER_VERSION "2.7.10" // Please also update in the Dockerfile to the same version
