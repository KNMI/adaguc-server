...
TEST(ToSeconds, TimeUtils) {
  ...
  long result = toSeconds(interval);
  CHECK(result == expected);
}

TEST(EstimateISO8601Duration, TimeUtils) {
  // Most straightforward case
  std::vector<CT::string> timestamps = {"2024-07-29T15:30:45", "2024-07-29T16:30:45", "2024-07-29T17:30:45", "2024-07-29T18:30:45"};
  CT::string expected("PT1H");
  CT::string result = estimateISO8601Duration(timestamps);
  CHECK(result == expected);

  // Most straightforward case, with UTC z
  std::vector<CT::string> timestamps_utc = {"2024-07-29T15:30:45Z", "2024-07-29T16:30:45Z", "2024-07-29T17:30:45Z", "2024-07-29T18:30:45Z"};
  CT::string expected_utc("PT1H");
  CT::string result_utc = estimateISO8601Duration(timestamps_utc);
  CHECK(result_utc == expected_utc);

  // Case with one timestep missing
  std::vector<CT::string> timestamps_with_gap = {"2024-07-29T15:30:45", "2024-07-29T16:30:45", "2024-07-29T18:30:45", "2024-07-29T19:30:45",
                                                 "2024-07-29T20:30:45", "2024-07-29T21:30:45", "2024-07-29T22:30:45", "2024-07-29T23:30:45"};
  ...
  std::vector<CT::string> leap_year_timestamps = {"2024-02-28T23:30:45", "2024-02-29T00:30:45", "2024-02-29T01:30:45", "2024-02-29T02:30:45"};
  ...
  std::vector<CT::string> complex_interval_timestamps = {"2024-07-01T08:00:00", "2024-07-06T18:00:00", "2024-07-12T04:00:00", "2024-07-17T14:00:00", "2024-07-23T00:00:00"};
