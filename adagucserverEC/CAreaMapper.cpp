    ...
    for(double dstpixel_x = 0.5;dstpixel_x < dfTileWidth + 0.5; dstpixel_x++){
        ...
        destPixelX >=0 && destPixelY>=0 && destPixelX < imageWidth && destPixelY< imageHeight) 
      {
        ...
        if(debug){
          bool draw = false;
          bool draw2 = false;
          if(sourceSampleX ==0||sourceSampleX==width-1||sourceSampleY ==0||sourceSampleY==height-1){draw=true;}
          if((sourceSampleX ==10||sourceSampleX==width-10)&& sourceSampleY >10 &&sourceSampleY<height-10){draw2=true;}
          if((sourceSampleY ==10||sourceSampleY==width-10)&& sourceSampleX >10 &&sourceSampleX<width-10){draw2=true;}
          if(draw){
