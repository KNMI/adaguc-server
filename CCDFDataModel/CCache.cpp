...
const char *CCache::getCacheFileNameToWrite() { return claimedCacheFileName.c_str(); }

const char *CCache::getCacheFileNameToRead() { return fileName.c_str(); }
